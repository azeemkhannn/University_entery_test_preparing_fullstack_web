  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={() => navigate('/dashboard/quizzes')} className="flex items-center space-x-1 text-sm font-medium text-indigo-600 hover:bg-indigo-50 px-3 py-1 rounded-md">
